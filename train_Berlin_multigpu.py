...
if __name__ == "__main__":
    ...
    for index, (val_w, val_d, val_r, _) in enumerate(val_loader):
        ...
        outputs = [net(x=[w, d, r], cheb_polynomials=cheb_polynomials) for w, d, r in zip(val_w, val_d, val_r)]
    ...
    for epoch in range(1, epochs + 1):
        ...
        for train_w, train_d, train_r, train_t in train_loader:
            ...
            with autograd.record():
                outputs = [net(x=[w, d, r], cheb_polynomials=cheb_polynomials) for w, d, r in zip(train_w, train_d, train_r)]
